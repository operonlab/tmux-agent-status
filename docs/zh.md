...
![tmux-agent-status 狀態列膠囊，依狀態統計 AI CLI —— 2 忙碌、1 受阻、3 閒置](screenshot.png)

*狀態列上的膠囊一眼掌握：忙碌（工作中）、受阻（等你處理）、閒置（待命）的 AI CLI pane，即時統計。*
...
| **tmux-agent-status　—— 你在這** | AI 窗格 busy／blocked／idle 膠囊 |
